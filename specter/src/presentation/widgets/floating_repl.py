"""
Floating REPL Window for Specter.
...
logger = logging.getLogger("specter.floating_repl")
...
class FloatingREPLWindow(SimpleREPLArrowMixin, REPLResizableMixin, QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self._window_state_ready = False  # Guard: don't save state during init
    ...
    def position_relative_to_avatar(self, avatar_pos: QPoint, avatar_size: tuple, screen_geometry):
        ...
        # Now that position/size is fully loaded, enable state saving
        self._window_state_ready = True
