"""
PKI Certificate Manager for Specter.
...
logger = logging.getLogger("specter.pki.certificate_manager")
...
class CertificateManager:
    ...
    def _get_pki_directory(self) -> Path:
        ...
        if os.name == 'nt':  # Windows
            ...
            return Path(appdata) / "Specter" / "pki"
        else:  # Linux/Mac
            home = os.path.expanduser("~")
            return Path(home) / ".Specter" / "pki"
