"""Alembic environment configuration for Specter conversation management."""
...
# Import our models
from specter.src.infrastructure.conversation_management.models.database_models import Base
