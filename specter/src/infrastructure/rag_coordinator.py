...
Manages the FAISS-only RAG capabilities with the Specter application.
...
logger = logging.getLogger("specter.rag_coordinator")


class RAGCoordinator:
    """
    Coordinates FAISS-only RAG functionality across the Specter application.
    ...
    def _get_persist_directory(self) -> str:
        ...
        data_dir = settings.get('paths.data_dir', os.path.expanduser('~/.Specter'))
