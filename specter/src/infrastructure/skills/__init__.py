"""
Specter Skills System - Main Module.

This package provides the skills framework for Specter, enabling executable
...
Example Usage:
    >>> from specter.src.infrastructure.skills import skill_manager
    >>>
    >>> # Register a skill
