# Specter Skills System Interfaces

> Clean, type-safe interfaces for extending Specter with custom skills

## Overview

The Specter Skills System provides a powerful, extensible framework for adding new capabilities to the AI assistant. This package defines the core interfaces, abstract classes, and data structures that form the foundation of the skills system.
...
```python
from specter.src.infrastructure.skills.interfaces import PermissionType
...
This code is part of the Specter project.
