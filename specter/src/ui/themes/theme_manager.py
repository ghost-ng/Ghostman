"""
Theme Manager for Specter Application.
...
logger = logging.getLogger("specter.theme_manager")
...
class ThemeManager(QObject):
    ...
    def set_theme(self, name: str) -> bool:
        ...
        theme_loggers = [
            logging.getLogger("specter.theme_manager"),
            logging.getLogger("specter.repl_widget"),
            logging.getLogger("specter.embedded_code_widget"),
            logging.getLogger("specter.style_registry"),
            logging.getLogger("specter.style_templates"),
        ]
