...
from ghostman.src.infrastructure.ai.api_client import (
...
from ghostman.src.infrastructure.ai.ai_service import (
    AIService, 
    ConversationContext, 
    ConversationMessage,
...
class TestAIService:
    ...
    def test_service_initialization(self):
        ...
        # Mock the API client
        with patch('ghostman.src.infrastructure.ai.ai_service.OpenAICompatibleClient'):
    ...
    @patch('ghostman.src.infrastructure.ai.ai_service.settings')
    ...
    @patch('ghostman.src.infrastructure.ai.ai_service.OpenAICompatibleClient')
