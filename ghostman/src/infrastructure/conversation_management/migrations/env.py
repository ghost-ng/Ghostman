"""Alembic environment configuration for Ghostman conversation management."""
...
# Import our models
from ghostman.src.infrastructure.conversation_management.models.database_models import Base
