"""
Migration management utilities for Ghostman conversation database.
...
logger = logging.getLogger("ghostman.migrations")
...
def run_migrations_from_cli():
    ...
    parser = argparse.ArgumentParser(description='Run Ghostman database migrations')
