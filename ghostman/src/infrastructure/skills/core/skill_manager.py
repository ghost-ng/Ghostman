...
logger = logging.getLogger("ghostman.skills.manager")
...
class SkillManager(ISkillManager):
    ...
    This is the main entry point for skill interactions in Ghostman.
    ...
    def __init__(
        ...
        Args:
            ...
            use_ai_fallback: Whether to use AI for ambiguous intent detection (default False)
