...
logger = logging.getLogger("ghostman.skills.task_tracker")
    ...
    def parameters(self) -> List[SkillParameter]:
        ...
        return [
            SkillParameter(
                ...
                type=str,
                required=True,
                description="Action: 'create', 'update', 'delete', 'list', 'get'",
                constraints={"enum": ["create", "update", "delete", "list", "get"]}
            ),
            SkillParameter(
                name="task_id",
                type=int,
        ...
        try:
            if action == "create":
                ...
                return SkillResult(
                    ...
                    error="Valid actions: create, update, delete, list, get"
                )
