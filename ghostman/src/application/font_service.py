...
class FontService:
    ...
    def get_semantic_font_css(self) -> str:
        ...
        try:
            ...
            targeting_css = """
            /* Ghostman Semantic Font Targeting - High Specificity Layer */
            @layer ghostman-fonts {
                /* AI Response Text Targeting */
                .ghostman-message-container.ghostman-ai-response .gm-text,
                .ghostman-message-container.ghostman-ai-response .gm-text p,
                .ghostman-message-container.ghostman-ai-response .gm-text span,
                .ghostman-message-container.ghostman-ai-response .gm-text div,
                .ghostman-message-container.ghostman-ai-response .gm-heading,
                .ghostman-message-container.ghostman-ai-response .gm-emphasis,
                .ghostman-message-container.ghostman-ai-response .gm-strong,
                .ghostman-message-container.ghostman-ai-response .gm-quote,
                .ghostman-message-container.ghostman-ai-response .gm-link {
                ...
                .ghostman-message-container.ghostman-user-input .gm-text,
                .ghostman-message-container.ghostman-user-input .gm-text p,
                .ghostman-message-container.ghostman-user-input .gm-text span,
                .ghostman-message-container.ghostman-user-input .gm-text div,
                .ghostman-message-container.ghostman-user-input .gm-heading,
                .ghostman-message-container.ghostman-user-input .gm-emphasis,
                .ghostman-message-container.ghostman-user-input .gm-strong,
                .ghostman-message-container.ghostman-user-input .gm-quote,
                .ghostman-message-container.ghostman-user-input .gm-link {
                ...
                .ghostman-message-container .gm-code-block code,
                .ghostman-message-container .gm-code-block pre,
                .ghostman-message-container .gm-code-block *,
                .ghostman-message-container code.gm-code-inline,
                .ghostman-message-container pre.gm-code-block,
                .ghostman-message-container pre.gm-code-block * {
                ...
                .ghostman-message-container.ghostman-ai-response .gm-text *:not(.gm-code-inline):not(.gm-code-block):not(code):not(pre) {
                    font-family: var(--gm-ai-response-font-family) !important;
                    font-size: var(--gm-ai-response-font-size) !important;
                }
                
                .ghostman-message-container.ghostman-user-input .gm-text *:not(.gm-code-inline):not(.gm-code-block):not(code):not(pre) {
                    font-family: var(--gm-user-input-font-family) !important;
                    font-size: var(--gm-user-input-font-size) !important;
                }
                
                /* Prevent theme overrides by using QTextEdit specificity */
                QTextEdit .ghostman-message-container.ghostman-ai-response .gm-text,
                QTextEdit .ghostman-message-container.ghostman-ai-response .gm-text * {
                    font-family: var(--gm-ai-response-font-family) !important;
                }
                
                QTextEdit .ghostman-message-container.ghostman-user-input .gm-text,
                QTextEdit .ghostman-message-container.ghostman-user-input .gm-text * {
                    font-family: var(--gm-user-input-font-family) !important;
                }
                
                QTextEdit .ghostman-message-container .gm-code-inline,
                QTextEdit .ghostman-message-container .gm-code-block,
                QTextEdit .ghostman-message-container .gm-code-block * {
                    font-family: var(--gm-code-snippets-font-family) !important;
                }
            }
