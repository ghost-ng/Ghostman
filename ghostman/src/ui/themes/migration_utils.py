...
logger = logging.getLogger("ghostman.migration_utils")
...
class MigrationConverter:
    ...
    def _add_modern_imports(self, lines: List[str]):
        ...
        import_lines = [
            "from ghostman.src.ui.themes.component_styler import style_button, style_input, apply_repl_style_to_widget",
            "from ghostman.src.ui.themes.style_registry import apply_style_to_widget",
            "from ghostman.src.ui.themes.repl_style_registry import REPLComponent"
        ]
...
class MigrationReporter:
    ...
    def generate_report(self, scan_results: Dict[str, List[LegacyPatternMatch]], 
        ...
        # Generate report
        report = f"""
# Ghostman Legacy Styling Migration Report
